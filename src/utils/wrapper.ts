...
export default class WrapperHandler {
  /**
   * Returns monkey patched function that tracks call count and cpu usage.
   */
  public static FuncWrapper<F extends (...a: any[]) => any>(func: F): F {
   ...
   */
  // private static WrapFunctions = WrapperHandler.FuncWrapper(
  ...
  //       .map(([funcName, func]) => ({
  //         [funcName]: WrapperHandler.FuncWrapper(func),
  //       }))
  //       .reduce((acc, entry) => Object.assign(acc, entry), {}) as T;
  //   }
  // );

  public static IntentWrapper<F extends (...a: any[]) => any>(
    // eslint-disable-next-line
this: any,
